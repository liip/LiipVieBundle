        ...
        return jQuery.widget("Liip.halloimage", {
            ...
            _create: function () {
                ...
                $('#' + this.options.uuid + '-' + widget.widgetName + '-upload').live('click', function(e) {
                    ...
                    $('#' + widget.options.uuid + '-' + widget.widgetName + '-tags').val(jQuery('.inEditMode').parent().find('.articleTags input').val());
                    ...
                    $('#postframe').load(
                        function(){
                            var src = $('#postframe')[0].contentWindow.location.href;
