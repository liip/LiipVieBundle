    ...
    return jQuery.widget("IKS.hallo", {
      ...
      _getToolbarPosition: function(event, selection) {
        ...
        if (event.originalEvent instanceof MouseEvent) {
            ...
            console.log(containerElement.position());
            var containerPosition = containerElement.position();

          return [containerPosition.left - 5, containerPosition.top - 45]; // Set the position here! - Colin
        }
      ...
      _prepareToolbar: function() {
        ...
        this.element.bind("halloselected", function(event, data) {
            console.log('halloselected event');
          var position, widget;
